...
def dataset_path(
    ...
    the analysis-runner, or can be optionally set up manually:
    ...
    * `workflow/dataset` and `workflow/access_level` config variables to be set.
    ...
    str
    """
    infrastructure = get_config()['infrastructure']
    dataset = dataset or 'default'
    category = category or 'default'
    prefix = get_config()[infrastructure]['buckets'][dataset][category]
